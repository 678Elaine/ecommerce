<button type="submit" name ="login"><a href= "add_brand.php"> Add a brand </a></button>
<button type="submit" name ="login"><a href= "update_brand.php"> Update a brand </a></button>
<button type="submit" name ="login"><a href= "add_category.php"> Add a Category</a></button>
